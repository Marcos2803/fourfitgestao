        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Foto = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    TipoPagamentoId1 = table.Column<int>(type: "int", nullable: true),
                    TipoPlanoId1 = table.Column<int>(type: "int", nullable: true),
                    UserId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlunosId1 = table.Column<int>(type: "int", nullable: false),
                    AlunosId = table.Column<string>(type: "nvarchar(max)", nullable: true),
